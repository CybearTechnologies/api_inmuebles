...
CREATE TABLE extra
(
    ex_id               int(10) AUTO_INCREMENT COMMENT 'ID Extra' PRIMARY KEY,
    ...
    CONSTRAINT extra_ibfk_1 FOREIGN KEY (ex_user_created_fk) REFERENCES user (us_id),
    CONSTRAINT extra_ibfk_2 FOREIGN KEY (ex_user_modified_fk) REFERENCES user (us_id)
);
